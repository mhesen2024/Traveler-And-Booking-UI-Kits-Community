                ...
                <div className="w-4/6 bg-white shadow-md rounded-lg p-6">
                    ...
                    <div className="mb-4 flex flex-wrap gap-4 sm:gap-2 lg:gap-4 xl:gap-6">
                        <button
                            ...
                            className={`px-4 py-2 text-sm md:text-base lg:text-lg xl:text-lg ${paymentMethod === 'debit' ? 'text-blue-500 border-b-2 border-blue-500' : 'text-gray-700'}`}
                        >
                            Debit/Credit Card
                        </button>
                        <button
                            onClick={() => handlePaymentMethodClick('paypal')}
                            className={`px-4 py-2 text-sm md:text-base lg:text-lg xl:text-lg ${paymentMethod === 'paypal' ? 'text-blue-500 border-b-2 border-blue-500' : 'text-gray-700'}`}
                        >
                            PayPal
                        </button>
                        <button
                            onClick={() => handlePaymentMethodClick('bank')}
                            className={`px-4 py-2 text-sm md:text-base lg:text-lg xl:text-lg ${paymentMethod === 'bank' ? 'text-blue-500 border-b-2 border-blue-500' : 'text-gray-700'}`}
                        >
                            Bank Transfer
                        </button>
                    </div>
                    {paymentMethod === 'debit' && (
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mb-4 flex space-x-4 w-3/4">
                                <div className="w-1/2">
