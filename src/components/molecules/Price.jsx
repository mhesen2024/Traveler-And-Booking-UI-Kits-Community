...
export default function Price() {
  return (
    <div  className='container flex flex-col w-[295px] h-[293px]  rounded-md border-2 border-[E0E0E0] space-y-[14px]  hover:border-2 hover:border-blue-500 '>
        <h2 className=' roboto-medium h-[55px] w-[295px] bg-[#F2F2F2] rounded-md py-[18px] pl-[18px] text-[#181818] hover:border-2 hover:border-blue-500 hover:underline hover:decoration-blue-500  ' style={{ borderRadius: '6px 6px 0px 0px' }}> Your budget per day</h2>
        ...
        <label className='block relative  flex items-center  mr-5  '> 
            ...
            <span className='  checkmark   roboto-regular  ml-[8px] text-[14px]'> </span> $0 - $200
        ...
        <div  className='block relative  flex items-center  mr-5 '> 
